...
module.exports = function (FriendResult,async, Users, Message,) {
  return {
    SetRouting: function (router) {
      router.get('/chat/:name', this.getchatPage);
      router.post('/chat/:name', this.chatPostPage);
    },
    getchatPage: function (req, res) { if(req.user===undefined){
        res.redirect('/signin');
      ...
      async.waterfall([
        ...
        function (data, callback) {
          if (req.body.message) {
            ...
            newMessage.receiverName = data.name;
